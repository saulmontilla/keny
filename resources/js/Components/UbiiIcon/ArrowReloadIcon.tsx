...
export default function ArrowReloadIcon(props: UbiiIconCommonProps) {
	...
	return (
		<svg {...svg.handlers} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			viewBox="0 0 488.482 488.482" xmlSpace="preserve">
			<g>
			...
			l5.9-0.1l6.4-0.8l12.9-1.7c40.2-7.1,78.4-25.4,108.8-53.2C432.182,393.241,445.882,377.541,456.382,359.741z" fill={svg.color1} />
			</g>
		</svg>
