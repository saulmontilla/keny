...
export default function ColorizedFileSuccess(props: UbiiIconCommonProps) {
    ...
    return (
        <svg {...svg.handlers} width="50" height="61" viewBox="0 0 50 61" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M24.8125 41.2451C29.2308 41.2451 32.8125 37.4171 32.8125 32.695C32.8125 27.973 29.2308 24.145 24.8125 24.145C20.3942 24.145 16.8125 27.973 16.8125 32.695C16.8125 37.4171 20.3942 41.2451 24.8125 41.2451Z" fill="#039855" />
