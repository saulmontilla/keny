...
export default function SearchIcon(props: UbiiIconCommonProps) {
    ...
    return (
        <svg {...svg.handlers} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 69.961 69.961" xmlSpace="preserve">
            <g>
		...
		s23.421,10.485,23.421,23.42c0,4.57-1.314,8.832-3.578,12.438l13.325,13.325C64.418,57.403,64.418,60.369,62.588,62.198z" fill={svg.color1} />
		...
		c5.928,0,10.75,4.822,10.75,10.75S35.348,40.561,29.42,40.561z" fill={svg.color1} />
            </g>
        </svg>
    )
}
